...
#   JSellers, 2/27/24, Edited script
# -------------------------------------------------------------------------------------------------------------------- #
import json
...
class Person:
    '''
    Class representing a person; contains first and last name.

    Chang Log (Who, When, What):
    JSellers, 2/27/24, Created class
    '''
...
class Student(Person):
    '''
    Class representing a student; adds course name in addition to the first and last name from the Person class.
...
class FileProcessor:
    ...
    def read_data_from_file(file_name: str, student_data: list):
        ...
        try:
            ...
            for student in students:  # Convert the list of dictionary rows into Student objects
